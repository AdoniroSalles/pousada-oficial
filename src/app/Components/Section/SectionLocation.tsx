        ...
        <div id="localizacao" className="container mx-auto h-full pt-8 flex flex-col">
            ...
            <div className="flex-1 flex flex-col gap-10 mt-2 lg:flex-row items-center">
                <div className="text-sm lg:text-base indent-10 text-justify lg:flex-1">
                    <p>Os chalés Estilo de Campos estão localizados em Campos do Jordão, uma encantadora cidade montanhosa situada na Serra da Mantiqueira, no estado de São Paulo. Rodeada por uma paisagem exuberante, os chalés desfrutam de uma localização privilegiada em meio a uma vegetação exuberante e belas montanhas.</p>
                    <br />
                    <p>Estamos estrategicamente posicionada em uma área tranquila e serena, oferecendo aos hóspedes um refúgio tranquilo longe do burburinho da cidade. Proporcionando uma atmosfera relaxante, perfeita para quem busca descanso, conforto e contato com a natureza.</p>
                </div>
